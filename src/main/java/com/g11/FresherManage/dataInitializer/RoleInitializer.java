...
public class RoleInitializer implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        if (roleRepository.count() == 0&&accountRepository.count() == 0&&accountRoleRepository.count() == 0) {
            ...
            Account accountAdmin=accountRepository.save(new Account(1,"admin","$2a$10$tEWOJ6PlKtjZTqhIZg1vl.3opnE.FusBZpWgeVi3ouuQ8y4tyra06","/tuan.img","Lương Nhật","Tuấn","nhattuan44t@gmail.com","0379230864","","active", LocalDate.parse("2024-07-03"),LocalDate.parse("2024-07-02"),""));
            Account accountMentor=accountRepository.save(new Account(1,"mentor","$2a$10$tEWOJ6PlKtjZTqhIZg1vl.3opnE.FusBZpWgeVi3ouuQ8y4tyra06","/tuan.img","Lương Nhật","Tuấn","nhattuan44t@gmail.com","0379230864","MENTOR","active",LocalDate.parse("2024-07-03"),LocalDate.parse("2024-07-02"),""));
            Account accountFresher=accountRepository.save(new Account(1,"fresher","$2a$10$tEWOJ6PlKtjZTqhIZg1vl.3opnE.FusBZpWgeVi3ouuQ8y4tyra06","/tuan.img","Lương Nhật","Tuấn","nhattuan44t@gmail.com","0379230864","FRESHER","active",LocalDate.parse("2024-07-03"),LocalDate.parse("2024-07-02"),""));
